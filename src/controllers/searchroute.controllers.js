...
//   // const checker = await schedules.aggregate([
//   //   {
//   //     $match: {
//   //       "trip.routeId": routeId._id,
//   //       "trip.scheduleDate": newdate,
//   //     },
//   //   },
//   //   {
//   //     $unwind: {
...
//   if (!routeId) {
//     throw new APIError(404, "Route is not available");
//   }

//   return res
//     .status(200)
//     .json(new APIResponse(200, checker, "Schedule Created"));
// });
